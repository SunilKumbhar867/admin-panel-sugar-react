...
// console.log(updateValue);
        ...
        },
        {
          ...
          options: {
            filter: true,
            customBodyRender: (value, tableMeta, updateValue) => {
console.log("/home/updatequiz?id="+value);
const url = "/home/updatequiz?id="+value;
                                  return (
                                    <Link to={url} >
   ...
   handleChangeDelete = (e, imgkey) =>{
    console.log(imgkey);
        fetch(process.env.REACT_APP_URL_NODE+'deleteQuestion',{
          method: 'POST',
          headers: {
  ...
  handleChange = (e, a) =>{
    ...
    console.log(a);
    e.preventDefault();
        fetch(process.env.REACT_APP_URL_NODE+'updateStatus',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  getData = (page) => {
    ...
    // console.log(page);
    fetch(process.env.REACT_APP_URL_NODE+'getQuestion',{
      method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
//   console.log(resData);
  ...
  render() {
    ...
    return (
      ...
      <Container fixed>
        <br />
      <Link to="/home/addquiz"><Button style={{
  //borderRadius: 35,
