...
const url = "/home/updategift?id="+value;
   ...
   handleChangeDelete = (e, imgkey) =>{
    console.log(imgkey);
        fetch(process.env.REACT_APP_URL_NODE+'deleteBlog',{
          method: 'POST',
          headers: {
  ...
  handleChange = (e, a) =>{
    ...
    console.log(a);
    e.preventDefault();
        fetch(process.env.REACT_APP_URL_NODE+'updateBlog',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  getData = (page) => {
    ...
    // console.log(page);
    fetch(process.env.REACT_APP_URL_NODE+'getBlog',{
      method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
//   console.log(resData);
  ...
  render() {
    ...
    return (
      ...
      <Container fixed>
        <br />
      <Link to="/home/addblog"><Button style={{
  //borderRadius: 35,
