...
// console.log(updateValue);
        ...
        },
        {
          ...
          options: {
            filter: true,
            customBodyRender: (value, tableMeta, updateValue) => {
console.log("/home/updatetitle?id="+value);
const url = "/home/updatetitle?id="+value;
                                  return (
                                    <Link to={url} >
   ...
   handleChangeDelete = (e, imgkey) =>{
    console.log(imgkey);
        fetch(process.env.REACT_APP_URL_NODE+'deleteTitle',{
          method: 'POST',
          headers: {
  ...
  handleChange = (e, a) =>{
    ...
    console.log(a);
    e.preventDefault();
        fetch(process.env.REACT_APP_URL_NODE+'updateTitle',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  getData = (page) => {
    ...
    // console.log(page);
    fetch(process.env.REACT_APP_URL_NODE+'getTitle',{
      method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
//   console.log(resData);
  ...
  render() {
    ...
    return (
      ...
      <Container fixed>
        <br />
      <Link to="/home/addtitle"><Button style={{
  //borderRadius: 35,
