...
// console.log(updateValue);
        ...
        },
        {
          ...
          options: {
            filter: true,
            customBodyRender: (value, tableMeta, updateValue) => {
console.log("/home/updatesliding?id="+value);
const url = "/home/updatesliding?id="+value;
                                  return (
                                    <Link to={url} >
  ...
  handleChangeDelete = (e, imgkey) =>{
    console.log(imgkey);
        fetch(process.env.REACT_APP_URL_NODE+'deleteSliding',{
          method: 'POST',
          headers: {
  ...
  handleChange = (e, a) =>{
    ...
    console.log(a);
    e.preventDefault();
        fetch(process.env.REACT_APP_URL_NODE+'updateSliding',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  getData = (page) => {
    ...
    // console.log(page);
    fetch(process.env.REACT_APP_URL_NODE+'getSliding',{
      method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
//   console.log(resData);
  ...
  render() {
    ...
    return (
      ...
      <Container fixed>
        <br />
      <Link to="/home/addsliding"><Button style={{
  //borderRadius: 35,
...
export default withStyles(styles)(sliding);
