...
class updatesliding extends Component {
    constructor(props) {
        super(props);
        this.state = { 
          id:'',
...
// }
    ...
    fetch(process.env.REACT_APP_URL_NODE+'getSlidingById',{
        method: 'POST',
        headers: {
  ...
  //  console.log(this.state.content);
      fetch(process.env.REACT_APP_URL_NODE+'updateSlidingData',{
          method: 'POST',
          body: formData,
          headers: {
      ...
      .then(resData => {
          ...
          this.props.history.push("/home/sliding");
      })
      .catch(err => {
          // console.log(err);
...
export default  withStyles(styles)(updatesliding);