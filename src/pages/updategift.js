...
// }
    ...
    fetch(process.env.REACT_APP_URL_NODE+'getGiftById',{
        method: 'POST',
        headers: {
  ...
  //  console.log(this.state.content);
      fetch(process.env.REACT_APP_URL_NODE+'updateGiftData',{
          method: 'POST',
          body: formData,
          headers: {
      ...
      .then(resData => {
          ...
          this.props.history.push("/home/gift");
      })
      .catch(err => {
          // console.log(err);
...
export default  withStyles(styles)(updategift);