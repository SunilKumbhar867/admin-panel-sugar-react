...
// console.log(updateValue);
        ...
        },
        {
          ...
          options: {
            filter: true,
            customBodyRender: (value, tableMeta, updateValue) => {
console.log("/home/updatesmalllayout?id="+value);
const url = "/home/updatesmalllayout?id="+value;
                                  return (
                                    <Link to={url} >
   ...
   handleChangeDelete = (e, imgkey) =>{
    console.log(imgkey);
        fetch(process.env.REACT_APP_URL_NODE+'deleteSmalllayout',{
          method: 'POST',
          headers: {
  ...
  handleChange = (e, a) =>{
    ...
    console.log(a);
    e.preventDefault();
        fetch(process.env.REACT_APP_URL_NODE+'updateSmalllayout',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  getData = (page) => {
    ...
    // console.log(page);
    fetch(process.env.REACT_APP_URL_NODE+'getSmalllayout',{
      method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
//   console.log(resData);
  ...
  render() {
    ...
    return (
      ...
      <Container fixed>
        <br />
      <Link to="/home/addsmalllayout"><Button style={{
  //borderRadius: 35,
