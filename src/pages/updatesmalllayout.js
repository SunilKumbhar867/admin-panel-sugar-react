...
class updatesmalllayout extends Component {
    constructor(props) {
        super(props);
        this.state = { 
          id:'',
...
// }
    ...
    fetch(process.env.REACT_APP_URL_NODE+'getSmallLayoutById',{
        method: 'POST',
        headers: {
  ...
  //  console.log(this.state.content);
      fetch(process.env.REACT_APP_URL_NODE+'updateSmallLayoutData',{
          method: 'POST',
          body: formData,
          headers: {
...
export default  withStyles(styles)(updatesmalllayout);